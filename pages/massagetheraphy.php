...
<head>
 <meta charset="utf-8">
  <title>Massage Theraphy - PrimeSpa</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Massage%20Therapy.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Massage Therapy
Experience total relaxation or benefit from therapeutic bodywork for pain management.  Depending on your needs, hot stone treatment, acupuncture, acupressure, or cupping are additional treatments you can add to get the most of your session.  Massage times range from 30 minutes to 2 hours.
<br><br>
              <i>30 minutes</i> – <b>$35</b>
<br><br>
                  <i>1 hour</i> – <b>$60</b>
<br><br>
                  <i>90 minutes</i> – <b>$75</b>
<br><br>
                  <i>2 hours</i> – <b>$95</b></p>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="waixing.php">
            <img class="container" height="150px" src="img/sld/Waxing.jpg" alt="">
          </a>
            <i class="text-dark "><center><b>Waxing</b></center></i>
        </div>
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="massagetheraphy.php" class="list-group-item active">Massage Theraphy</a>
            <a href="waixing.php" class="list-group-item text-info">Waixing</a>
