...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeSpa</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Here Comes the Bride Beauty Packages
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/bridal.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Schedule a visit with our esthetician who will help you put together a beauty package that will leave you and your bridal party (including your groom) looking and feeling their best on the big day.  Many of our brides set up a bridal registry where friends and family can contribute to their account.  Packages are customized to fit your budget and needs.   It’s the perfect gift!</p>
   ...
   <i>There is no Related Services...</i>
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="bridalparty.php" class="list-group-item active">Bridal Party Beauty</a>
