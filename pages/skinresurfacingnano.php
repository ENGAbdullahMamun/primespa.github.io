...
<head>
 <meta charset="utf-8">
  <title>Skin Resurfacing with Nano Laser Peel - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Skin Resurfacing with Nano Laser Peel
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <p>Reveal smooth and luminous skin in 30 minutes with the lunch-time NanoLaser Peel.  Perfect for those who want Skin Resurfacing to refresh their skin with no downtime.
<br><br>
...
<br><br>
Skin resurfacing with the  NanoLaserPeel from Sciton can do much more. It uses light energy to instantly remove the top layers of the skin at a depth that also accelerates the skin’s own renewal process by activating special messenger proteins. Microdermabrasion and chemical peels often don’t get deep enough and other lasers leaves a layer of heat-damaged cells that interrupt the ability of these messenger cells to communicate with deep layers of skin. Skin resurfacing with  NanoLaserPeel from Sciton has the precision to work at just the right depth, creating beautifully smooth, luminous skin.
<br><br>
Our mission is to help you feel confident in your skin every day by combining the art and science of beauty to help you achieve the look you desire.  We provide top-of-the-line, physician-directed services and medical grade skin care products.</p>
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="skinresurfacingnano.php" class="list-group-item active">Skin Resurfacing with Nano Laser Peel</a>
          </div>
        </div>
        <!-- /.col-lg-9 -->
