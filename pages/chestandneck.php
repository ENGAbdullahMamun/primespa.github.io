...
<head>
 <meta charset="utf-8">
  <title>Chest and Neck Rejuvenation - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Chest and Neck Rejuvenation
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Chest%20and%20Neck%20Rejuvenation.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>The neck and chest are one of the first places to reveal signs of aging. The skin on the neck is thin and weak, and most of us forget about our décolletage in our daily skin care regimen. At Prime Medical Spa we offer a combination of innovative laser treatments and products to restore your delicate skin to a more youthful appearance.
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="chestandneck.php" class="list-group-item active">Chest And Neck Rejuvenation</a>
