...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Waxing.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Facial waxing is a great alternative to laser hair removal. Waxing provides smooth, silky, hair-free skin for a longer period of time than shaving. Waxing also does not cause stubble associated with shaving.  At Prime what we use is non-wax.  Because it’s not a wax it never sticks to the skin.  This system is self-preserving anti-bacterial/anti-microbial so it’s safe, clean and germ free.   The next time you need a brow or lip wax, give this a try.  You will never go back to regular waxing again.
<br>
<br>
              <i>Brow wax</i> – <b>$12</b>
<br>
...
<br>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="dermaplane.php">
            <img class="container" height="150px" src="img/sld/Dermaplane.jpg" alt="">
          </a>
            <i class="text-dark "><center><b>Dermaplane</b></center></i>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="massagetheraphy.php">
            <img class="container" height="150px" height="50px" src="img/sld/Massage%20Therapy.jpg" alt="">
          </a>
             <i class="text-dark "><center><b>Massage Therapy</b></center></i>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="redken.php">
            <img class="container" height="150px" height="100px" src="img/sld/Redken%20Salon.jpg" alt="">
          </a>
              <i class="text-dark "><center><b>Redken Salon</b></center></i>
        </div>
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
              <h3 class=" list-group-item bg-dark text-white"><b><center>PrimeSpa</center></b></h3>
            <a href="bridalparty.php" class="list-group-item text-info">Bridal Party Beauty</a>
            <a href="dermaplane.php" class="list-group-item text-info">Dermaplane</a>
            <a href="massagetheraphy.php" class="list-group-item text-info">Massage Theraphy</a>
            <a href="waixing.php" class="list-group-item active">Waixing</a>
            <a href="redken.php" class="list-group-item text-info">Redken Salon</a>
          </div>
        </div>
        <!-- /.col-lg-9 -->
