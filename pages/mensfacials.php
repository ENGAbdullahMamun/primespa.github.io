...
<head>
 <meta charset="utf-8">
  <title>Dermaplane Facials - PrimeMen</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMen</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/menfacial.jpg" alt="">
        </div>
...
Schedule a complimentary consultation for pricing</p>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="menslasehairremovel.php">
            <img class="container" height="150px" src="img/sld/Men's%20Laser%20Hair%20Removel.jpg" alt="">
          </a>
            <i class="text-dark "><center><b>Men's Laser Hair Removel</b></center></i>
        </div>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="hairlossrestorationmen.php">
            <img class="container" height="150px" height="50px" src="img/sld/menhairloss.jpg" alt="">
             ...
             <i class="text-dark "><center><b>Men Hair Loss</b></center></i>
        </div>
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="mensfacials.php" class="list-group-item active">Mens Facials</a>
            <a href="hairlossrestorationmen.php" class="list-group-item text-info">Hair Loss Restoration Men</a>
            <a href="menslasehairremovel.php" class="list-group-item text-info">Men's Laser Hair Removel</a>
          </div>
        </div>
        <!-- /.col-lg-9 -->
