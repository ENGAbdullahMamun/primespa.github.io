...
<head>
 <meta charset="utf-8">
  <title>Skin Resurfacing - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Skin Resurfacing
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Skin%20Resurfacing.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>We can lift years from your face with the latest in Sciton laser skin resurfacing technology. At Prime, we stay on top of the latest trends and newest technology, including combination therapies, so we can offer our clients beauty treatments that deliver results.
<br><br>
              <b>Skin-Tyte:</b> Utilizes advanced, infrared technology and patient-tailored filters to deeply heat dermal collagen while continuously protecting the treated epidermis with sapphire contact cooling for optical clinical endpoints, safety and comfort. The energy is delivered in rapid, gentle pulses to promote contraction and partial coagulation of the collagen initiating the body’s natural healing process, leading to the appearance of firmer tissue. Utilized on all skin types with no downtime.

Schedule a complimentary consultation for pricing
<br><br>
    <b>Kybella®:</b> is the first and only FDA-approved, nonsurgical treatment that contours and improves the appearance of submental fullness (double chin). When injected into the fat beneath your chin, Kybella® causes the destruction of fat cells. Once destroyed, those cells cannot store or accumulate fat. Treatment is typically required 2-4 times in 7-10 week intervals, and the results are permanent.

 Schedule a complimentary consultation for pricing
<br><br>
    <b>ClearToe:</b> Laser treatment of onychomycosis (toe nail fungus) with the Sciton ClearSense application is both safe and effective. The ClearToe treatment is a very rapid and affordable treatment that promotes clear nils in patients who suffer from onycomycosis.

Schedule a complimentary consultation for pricing
<br><br>
    <b>Ozone Therapy:</b> has been utilized and extensively studied for many decades. Ozone inactivates bacteria, viruses, fungi, yeast and protozoa. Ozone stimulates oxygen metabolism and activates the immune system. Ozone is utilized in our office to treat the following (*Individual results vary and are not guaranteed):
<br><br>
    <li><b>Yeast</b></li>
    <li><b>Acne</b></li>
    <li><b>Under-eye circles</b></li>
    <li><b>Spider veins</b></li>

<br><br>
Schedule a complimentary consultation for pricing</p>
 <br><br>         <h3 class="my-3">Categories :</h3>
          <ul>
            <li><i>PrimeMed</i></li>
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="dermalFilter.php" class="list-group-item text-info">Dermal Filter</a>
            ...
            <a href="skinResufacing.php" class="list-group-item active">Skin Resurfacing</a>
