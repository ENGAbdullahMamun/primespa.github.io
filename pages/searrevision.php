...
<section id="" class="wow fadeInUp">
      <div class="bg-dark" style="margin-top: Auto">
  <center> 	<div class="continer m-auto p-auto">
<div class="d-inline-block col-md-2 col-lg-2 col-xl-2 col-sm-2 text-white">
	<ul class="pp-icon-list-items pp-list-type-icon">


			<li class="pp-icon-list-item pp-icon-list-item-0">
				<span class="pp-list-item-icon fa fa-map-marker"></span>
				<span class="pp-list-item-text"><strong>Location</strong><br>7307 S Yale Ave Tulsa, OK 74136</span>
			</li>
...
<div class="d-inline-block col-md-2 col-lg-2 col-xl-2 col-sm-2 text-white">
	<ul class="pp-icon-list-items pp-list-type-icon">
			...
			<li class="pp-icon-list-item pp-icon-list-item-0">
				<span class="pp-list-item-icon ua-icon ua-icon-users"></span>
				<span class="pp-list-item-text"><strong>Experienced</strong><br>Team</span>
			</li>
...
<div class="d-inline-block col-md-2 col-lg-2 col-xl-2 col-sm-2 text-white">
	<ul class="pp-icon-list-items pp-list-type-icon">
			...
			<li class="pp-icon-list-item pp-icon-list-item-0">
				<span class="pp-list-item-icon fi-widget"></span>
				<span class="pp-list-item-text"><strong>Cutting Edge</strong> <br>Technology</span>
			</li>
...
<div class="d-inline-block col-md-2 col-lg-2 col-xl-2 col-sm-2 text-white">
	<ul class="pp-icon-list-items pp-list-type-icon">
			...
			<li class="pp-icon-list-item pp-icon-list-item-0">
				...
				<span class="pp-list-item-text"><strong>You will feel</strong><br>Rejuvenated</span>
			</li>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Acne%20Treatments.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Smooth, lighten, and remove redness or pigmentation from scars. At Prime, we have several treatment options from lasers to micro-needling to improve or eliminate the scars you’ve been hiding.
<br><br>
              <b>Platelet-rich Plasma (PRP):</b> is a substance derived from your own blood that can be used to trigger a healing response. Platelets contain several growth factors that attract stem cells and increae rebuilding of tissues over several months. PRP has recently become popular for healing sports injuries and for cosmetic procedures to increase collagen and improve overall skin health. * Individual results may vary and are not guaranteed.
<br><br>
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="searrevision.php" class="list-group-item active">Sear Revision</a>
