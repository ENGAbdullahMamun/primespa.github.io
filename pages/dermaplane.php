...
<head>
 <meta charset="utf-8">
  <title>Dermaplane - PrimeSpa</title>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <p>With dermaplane, a Prime esthetician uses a specialized tool to safely, painlessly and gently remove fine, unwanted facial  hair. At the same time, dermaplane also removes the top layer of dead skin cells, revealing smoother, younger-looking skin.
<br><br>
Schedule a complimentary consultation for pricing</p>
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="dermaplane.php" class="list-group-item active">Dermaplane</a>
            <a href="massagetheraphy.php" class="list-group-item text-info">Massagetheraphy</a>
