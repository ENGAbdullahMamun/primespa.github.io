...
<head>
 <meta charset="utf-8">
  <title>Hair Loss Restoration - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Hair Loss Restoration
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/hairloos.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Hair loss restoration services at Prime are provided by Hair Loss Restoration Co.<BR><BR>

Early Detection
<BR><BR>
Scalp and hair analysis for hair loss
<BR><BR>
Multi-therapeutic programs and laser treatment
<BR><BR>
Hairwear for those who want an instant solution for thinning hair
<BR><BR>
More information and appointment booking is available at <a href="http://www.hairlossrestorationco.com/">http://www.hairlossrestorationco.com</a></p>
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="hairlossrestoration.php" class="list-group-item active">Hair Lose Restoration</a>
