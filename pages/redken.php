...
<head>
 <meta charset="utf-8">
  <title>Redken Salon - PrimeSpa</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeSpa</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Redken%20Salon.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Prime Medical Spa is home to Redken certified hair colorist and design stylist, Sarah Dean.  Sarah carries an extensive line of Redken color lines and sells Redken and Purology haircare products.  When she’s not seeing guests, Sarah travel extensively as a Redken artist teaching and inspiring other salon professionals.
<br>
<br>
              Women’s hair cuts start at <b>$53</b>, Color starts at $63, Men’s cuts <b>$38</b></p>
      ...
      <h3 class="my-4">Related Services</h3>
       ...
       <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="waixing.php">
            <img class="container" height="150px" height="100px" src="img/sld/Waxing.jpg" alt="">
          </a>
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="redken.php" class="list-group-item active">Redken Salon</a>
          </div>
        </div>
        <!-- /.col-lg-9 -->
