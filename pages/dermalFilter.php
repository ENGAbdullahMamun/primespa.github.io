...
<head>
 <meta charset="utf-8">
  <title>Dermal Filler - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Dermal%20Fillers.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p><span class="text-info i">Juvéderm®</span> is an injectable gel dermal filler with a hyaluronic acid base – a substance your body creates naturally. A “next generation” filler, with the highest concentration of hyaluronic acid it works wonders to plump up hollows and erase wrinkles especially around the nose and mouth.

Schedule a complimentary consultation for pricing
    </br></br>
<span class="text-info i">Juvéderm Volbella XC®</span> Adding subtle volume to lips and lip lines has never been easier. Volbella provides minimal enhancement for the more conservative client. It can provide lip enhancement for up to one year.

Schedule a complimentary consultation for pricing
</br></br>
<span class="text-info i">Juvéderm Vollure XC®</span> is part of the Juvaderm collection of hyaluronic acid facial fillers, primarily used for smoothing nasolabial folds. The fillers use Vycross technology, which blends different molecular weighs of hyaluronic acid to deliver results that last up to 18 months.

Schedule a complimentary consultation for pricing
</br></br>
<span class="text-info i">Bellafill®</span> is a smooth, collagen-based filler with PMMA microspheres.The microspheres in Bellafill® are half the diameter of a human hair, so small that they are virtually invisible to the eye. The microspheres are made of polymethylmethacrylate (PMMA), a biocompatible material that has been used in medical implants for 65 years. The PMMA recreates the firm structure of smoother looking skin by supporting production of your body’s own collagen. The collagen in Bellafill® provides immediate volume and lift, over time the collagen is absorbed by the body. The PMMA microspheres remain in place and create a matrix that supports production of the body’s own collagen for lasting correction. Bellafill® is a 5+ year filler. A minimum of three syringes must be ordered and a skin test is required one month prior to treatment.

Schedule a complimentary consultation for pricing
</br></br>
<span class="text-info i">RADIESSE®</span> Volumizing Dermal Filler works immediately so the results are instant. Once injected, RADIESSE Volumizing Filler adds the volume and lift needed to diminish the signs of aging. What makes RADIESSE truly unique is the ability of the product to act as a scaffold under the skin, providing structure and stimulating your own natural collagen to grow. The production of natural collagen continues for several months, which extends beyond the initial effect of RADIESSE Volumizing Filler. Best of all, the natural results are clinically proven to last a year or more in many patients, which means more value from each treatment and long-lasting results.

Schedule a complimentary consultation for pricing
</br></br>
<span class="text-info i">Juvederm Voluma®</span> XC  As you age, it’s not just about lines and wrinkles. Your cheeks can lose volume and skin may begin to sag. JUVÉDERM VOLUMA® XC is the first and only FDA-approved injectable gel to instantly add volume to your cheek area to correct age-related volume loss. It can provide you contour and a subtle lift for up to two years with optimal treatment.

Schedule a complimentary consultation for pricing</p>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="hairlossrestoration.php">
            <img class="container" height="150px" src="img/sld/hairloos.jpg" alt="">
          </a>
            <i class="text-dark "><center><b>Hair Loss Restoration</b></center></i>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="skinResufacing.php">
            <img class="container" height="150px" height="50px" src="img/sld/Skin%20Resurfacing.jpg" alt="">
          </a>
             <i class="text-dark "><center><b>Skin Resurfacing with Nano Laser Peel</b></center></i>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="permanetcosmetic.php">
            <img class="container" height="150px" height="100px" src="img/sld/Permanent%20Cosmetics.png" alt="">
          </a>
              <i class="text-dark "><center><b>Permanent Cosmetics</b></center></i>
        </div>

        <div class="col-md-3 col-sm-6 mb-4">
          <a href="profacial.php">
            <img class="container" height="150px" src="img/sld/Profractional.jpg" alt="">
          </a>
              <i class="text-dark "><center><b>ProFractional Therapy</b></center></i>
        </div>

<div class="col-md-3 col-sm-6 mb-4">
          <a href="queladge.php">
            <img class="container" height="150px" src="img/sld/queladge.jpg" href="queladge.php" alt="">
          </a>
              <i class="text-dark "><center><b>Quelage Peel</b></center></i>
        </div>
      </div>
      <!-- /.row -->
          ...
          <div class="list-group">
              <h3 class=" list-group-item bg-dark text-white"><b><center>PrimeMed</center></b></h3>
            <a href="Acne.php" class="list-group-item text-info">Acne Treatments</a>
            <a href="botox.php" class="list-group-item text-info">Botox</a>
            <a href="dermalFilter.php" class="list-group-item active">Dermal Filter</a>
            <a href="dremplanefacials.php" class="list-group-item text-info">Dremplane Facials</a>
            <a href="melanageMinPeel.php" class="list-group-item text-info">Melanage Min Peel</a>
            <a href="skinResufacing.php" class="list-group-item text-info">Skin Resurfacing</a>
            <a href="BBLlaser.php" class="list-group-item text-info">BBL Laser Hair Removel</a>
            <a href="chestandneck.php" class="list-group-item text-info">Chest And Neck Rejuvenation</a>
            <a href="hairlossrestoration.php" class="list-group-item text-info">Hair Lose Restoration</a>
            <a href="microlaserpeel.php" class="list-group-item text-info">Microlaser Peel</a>
            <a href="permanetcosmetic.php" class="list-group-item text-info">Permanet Cosmetics</a>
            <a href="searrevision.php" class="list-group-item text-info">Sear Revision</a>
            <a href="profacial.php" class="list-group-item text-info">Photo Facial</a>
            <a href="queladge.php" class="list-group-item text-info">Queladge</a>
            <a href="profacialtherafy.php" class="list-group-item text-info">Profacial Therafy</a>
            <a href="skinresurfacingnano.php" class="list-group-item text-info">Skin Resurfacing with Nano Laser Peel</a>
          </div>
        </div>
        <!-- /.col-lg-9 -->
