...
<head>
 <meta charset="utf-8">
  <title>Dermaplane Facials - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Dermaplane Facials
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Dermaplane.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p><b>Rejuvenating Facial – Hydrates normal to dry skin (1 hour)</b>
Fall in love with our all-inclusive, results-oriented, signature facial. This treatment is customized and designed to reveal radiant skin and reduce visible signs of aging by restoring firmness, texture and tone to the skin.  This facial includes a brightening wash with botanical extracts and exfoliants followed by a microdermabrasion scrub consisting of Polynesian volcanic black sand and ultra-fine pumice to remove dull, dry skin cells.  Freshwater silt helps to remove toxins while nourishing and hydrating the skin.   A facial massage, dermaplane and hydrating serum complete your facial leaving you with a rejuvenated, polished completion.
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="dremplanefacials.php" class="list-group-item active">Dremplane Facials</a>
