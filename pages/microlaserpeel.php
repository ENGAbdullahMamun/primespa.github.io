...
<head>
 <meta charset="utf-8">
  <title>Microlaser Peel - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Microlaser%20Peel.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Microlaser Peel is recommended to treat pigmentation issues, fine lines, tone and texture. During treatment, the Sciton laser-resurfacing device precisely removes the outermost layers of skin at a pre-determined depth to restore a more youthful appearance. Microlaser Peels are customized to the needs of each individual and to the specific skin conditions to be corrected.  Healing generally takes three to seven days depending on the depth of the peel.  Ideally, we have our clients prep their skin two weeks prior to treatment. The procedure can be performed on a Friday and you can return to work the following Monday.  Clients are encouraged to invest in post-treatment products to insure proper healing and better results.<br><br>
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="microlaserpeel.php" class="list-group-item active">Microlaser Peel</a>
