...
<head>
 <meta charset="utf-8">
  <title>Melanage Mini Peel - PrimeMed</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeMed</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <h1 class="my-4">Melanage Mini Peel
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/Melanage%20Peel.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Skin discoloration and hyper-pigmentation or “brown spots” on the face are caused by a number of factors including genetics, pregnancy, sun exposure and acne trauma. The Melanage Peel is a medical grade peel that dramatically lightens existing spots and improves skin texture, while penetrating the skin’s deeper layers to inhibit future discoloration from surfacing.  Continued improvements will be seen with custom-blended Melanage 2 Cream included with your treatment for home use. What makes this peel so amazing is that it is safe to use on patients with darker complexions giving us a solution to help clients of all skin types.
<br><br>
...
<div class="col-md-3 col-sm-6 mb-4">
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="melanageMinPeel.php" class="list-group-item active">Melanage Min Peel</a>
