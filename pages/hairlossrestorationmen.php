...
<head>
 <meta charset="utf-8">
  <title>Here Comes the Bride Beauty Packages - PrimeSpa</title>
...
<a href="Acne.php"> <center class="wow fadeInUp text-dark h4"><b>PrimeSpa</b></center></a><hr>
     ...
     <div class="p-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img class="img-fluid" src="img/sld/menhairloss.jpg" alt="">
        </div>

        <div class="col-md-8">
          <h3 class="my-3">Description</h3>
          <p>Hair loss restoration services at Prime are provided by Hair Loss Restoration Co.
<br>
<br>
              <li>Early Detection</li>
<br>
<br>
              <li>Scalp and hair analysis for hair loss</li>
<br>
<br>
              <li>Multi-therapeutic programs and laser treatment</li>
<br>
<br>
              <li>Hairwear for those who want an instant solution for thinning hair</li>
<br>
<br>
More information and appointment booking is available at <a href="http://www.hairlossrestorationco.com/">www.hairlossrestorationco.com</a></p>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="menslasehairremovel.php">
            <img class="container" height="150px" height="50px" src="img/sld/Men's%20Laser%20Hair%20Removel.jpg" alt="">
          </a>
      ...
      <!-- /.row -->
          ...
          <div class="list-group">
            ...
            <a href="hairlossrestorationmen.php" class="list-group-item active">Hair Loss Restoration Men</a>
